...
eventToDE :: SY.SY (Value Int) -> SY.SY (Value a) -> DE.DE (Value a)
eventToDE (SY.SY t) (SY.SY a) = DE.DE (unsafeFromValue t) a

toDE  ::  SY.Sig Int -> SY.Sig a                                     -> DE.Sig a
toDE2 ::  SY.Sig Int -> SY.Sig a -> SY.Sig b                         -> (DE.Sig a, DE.Sig b)
toDE3 ::  SY.Sig Int -> SY.Sig a -> SY.Sig b -> SY.Sig c             -> (DE.Sig a, DE.Sig b, DE.Sig c)
toDE4 ::  SY.Sig Int -> SY.Sig a -> SY.Sig b -> SY.Sig c -> SY.Sig d -> (DE.Sig a, DE.Sig b, DE.Sig c, DE.Sig d)
