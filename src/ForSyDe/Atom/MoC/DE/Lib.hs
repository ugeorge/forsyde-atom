...
scanld11 :: (b1 -> a1 -> b1) -> Int -> b1
         -> Sig a1 -> Sig b1                                
scanld12 :: ((b1, b2) -> a1 -> (b1, b2)) -> Int -> (b1, b2)
         -> Sig a1 -> (Sig b1, Sig b2)                          
scanld13 :: ((b1, b2, b3) -> a1 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
         -> Sig a1 -> (Sig b1, Sig b2, Sig b3)                      
scanld14 :: ((b1, b2, b3, b4) -> a1 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
         -> Sig a1 -> (Sig b1, Sig b2, Sig b3, Sig b4)                  
scanld21 :: (b1 -> a1 -> a2 -> b1) -> Int -> b1
         -> Sig a1 -> Sig a2 -> Sig b1                          
scanld22 :: ((b1, b2) -> a1 -> a2 -> (b1, b2)) -> Int -> (b1, b2)
         -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2)                    
scanld23 :: ((b1, b2, b3) -> a1 -> a2 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
         -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3)                
scanld24 :: ((b1, b2, b3, b4) -> a1 -> a2 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
         -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3, Sig b4)                     
scanld31 :: (b1 -> a1 -> a2 -> a3 -> b1) -> Int -> b1
         -> Sig a1 -> Sig a2 -> Sig a3 -> Sig b1                    
scanld32 :: ((b1, b2) -> a1 -> a2 -> a3 -> (b1, b2)) -> Int -> (b1, b2)
         -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2)              
scanld33 :: ((b1, b2, b3) -> a1 -> a2 -> a3 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
         -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3)          
scanld34 :: ((b1, b2, b3, b4) -> a1 -> a2 -> a3 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
         -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3, Sig b4)     
scanld41 :: (b1 -> a1 -> a2 -> a3 -> a4 -> b1) -> Int -> b1
         -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> Sig b1              
scanld42 :: ((b1, b2) -> a1 -> a2 -> a3 -> a4 -> (b1, b2)) -> Int -> (b1, b2)
         -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2)        
scanld43 :: ((b1, b2, b3) -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
         -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3)    
scanld44 :: ((b1, b2, b3, b4) -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
         -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3, Sig b4)
...
scanl11 :: (b1 -> a1 -> b1) -> Int -> b1
        -> Sig a1 -> Sig b1                                
scanl12 :: ((b1, b2) -> a1 -> (b1, b2)) -> Int -> (b1, b2)
        -> Sig a1 -> (Sig b1, Sig b2)                          
scanl13 :: ((b1, b2, b3) -> a1 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3)                      
scanl14 :: ((b1, b2, b3, b4) -> a1 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
        -> Sig a1 -> (Sig b1, Sig b2, Sig b3, Sig b4)                  
scanl21 :: (b1 -> a1 -> a2 -> b1) -> Int -> b1
        -> Sig a1 -> Sig a2 -> Sig b1                          
scanl22 :: ((b1, b2) -> a1 -> a2 -> (b1, b2)) -> Int -> (b1, b2)
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2)                    
scanl23 :: ((b1, b2, b3) -> a1 -> a2 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3)                
scanl24 :: ((b1, b2, b3, b4) -> a1 -> a2 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
        -> Sig a1 -> Sig a2 -> (Sig b1, Sig b2, Sig b3, Sig b4)                     
scanl31 :: (b1 -> a1 -> a2 -> a3 -> b1) -> Int -> b1
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig b1                    
scanl32 :: ((b1, b2) -> a1 -> a2 -> a3 -> (b1, b2)) -> Int -> (b1, b2)
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2)              
scanl33 :: ((b1, b2, b3) -> a1 -> a2 -> a3 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3)          
scanl34 :: ((b1, b2, b3, b4) -> a1 -> a2 -> a3 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
        -> Sig a1 -> Sig a2 -> Sig a3 -> (Sig b1, Sig b2, Sig b3, Sig b4)     
scanl41 :: (b1 -> a1 -> a2 -> a3 -> a4 -> b1) -> Int -> b1
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> Sig b1              
scanl42 :: ((b1, b2) -> a1 -> a2 -> a3 -> a4 -> (b1, b2)) -> Int -> (b1, b2)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2)        
scanl43 :: ((b1, b2, b3) -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3)) -> Int -> (b1, b2, b3)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3)    
scanl44 :: ((b1, b2, b3, b4) -> a1 -> a2 -> a3 -> a4 -> (b1, b2, b3, b4)) -> Int -> (b1, b2, b3, b4)
        -> Sig a1 -> Sig a2 -> Sig a3 -> Sig a4 -> (Sig b1, Sig b2, Sig b3, Sig b4)
